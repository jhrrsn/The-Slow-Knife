...
£8,000 goal, funding until 17/3/22
...
The Slow Knife is a game of wretched scoundrels and patient revenge for 2-4 players. It's inspired by stories like The Count of Monte Cristo, where a simple death is too good for all those years the villains took from their victim. This isn't a John Wick-style action flick, no—this is curt whispers over fine wine, jewelled masks of jade and bone, half-buried scandals and half-heard truths, and yes - sometimes - a quiet blade in the dark.
...
The Slow Knife is inspired by games like For the Queen that are rules-lite enough to eschew a manual, instead teaching the table the rules through a series of cards. This, along with a guided setup process that takes you through the creation of your world and characters, means that you don't have to do any kind of prep going into a game—just open the box and get going.

Here's what you'll find (subject to change!):

- 20 tutorial cards, to teach the rules of the game.
- 1 reference card, because who doesn't love a reminder.
- 13 prelude cards, to establish your setting & characters.
- 4 act cards, to set up and explain the 4 acts.
- 52 prompt cards, split into 4 acts

The cards will be printed in a gloriously large tarot-sized format (2.75" x 4.75") on blue-core cardstock. 'Blue core' is a standard card production technique where a thicker sheet of paper is sandwiched between the printed sheets, which makes them easier to shuffle, opaque and (most importantly) more durable for repeated plays.

But Jack! you cry, You can't just mail me ninety loose cards, you maniac! Oh yeah, there's also a box! A nice two-piece container to keep all your cards safe. Oh, and there's that lovely artwork again—let's talk about that.

This time around we've got the inimitable Rafael Nobre on board for the illustrations. I came across his work when looking at Count of Monte Cristo covers, and as soon as I saw his take I knew he'd be perfect for this project (check it out, it's great!).
